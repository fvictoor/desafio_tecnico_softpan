...
USUARIO_API - Teste realizando um cadastro de usuário e exclusão
    [Documentation]    Nesse cenário vamos estar realizando o cadastro de um usuário comum no sistema.
...
USUARIO_API - Teste realizando um cadastro de usuário administrador e exclusão
    [Documentation]    Nesse cenário vamos estar realizando o cadastro de um usuário administrador no sistema.
    [Tags]    api    cadastro    positivo 
...
USUARIO_API - Teste realizando Login com informações incorretas    
    [Documentation]    Nesse cenário vamos estar validando a mensagem de erro ao tentar realizar o login com informações incorretas.
...
USUARIO_API - Teste realizando um cadastro de usuário com o mesmo email
    [Documentation]    Nesse cenário vamos estar validando a mensagem de erro ao tentar cadastrar um usuário com o mesmo email.
    [Tags]    api    cadastro    negativo
...
USUARIO_API - Teste realizando a edição de um usuário
    [Documentation]    Nesse cenário vamos estar realizando a edição de um usuário no sistema.
